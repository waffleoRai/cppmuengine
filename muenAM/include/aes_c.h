...
int32_t AES_RCON[256];
int32_t AES_SBOX[256];
int32_t AES_SBOXINV[256];

typedef struct aes_key128{

    byte aes_key[AES_KEYBYTES_128];
    byte key_sched[AES_KEYSLOTS_128][AES_KEYBYTES_128];

    boolean is_init = 0;

} aes_key128_t;

typedef struct aes_state128{
